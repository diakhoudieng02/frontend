    ...
    <AuthLayout>
      <div className="mb-6 flex flex-col items-center gap-3 animate-fade-in">
        ...
        <div className="inline-flex items-center gap-1.5 rounded-full bg-sage-blue-50 px-3 py-1">
          ...
          <span className="text-xs font-medium text-primary">Connexion sécurisée</span>
        </div>
        <h1 className="text-2xl font-display font-bold text-foreground">Bienvenue sur ETOOBLO AI</h1>
        <p className="text-muted-foreground text-sm">Connectez-vous rapidement avec votre téléphone</p>
      </div>
      ...
      <div className="card-elevated rounded-2xl p-6 animate-slide-up">
        <div className="mb-5 flex items-start gap-3 rounded-xl bg-sage-blue-50 p-3">
          ...
          <div>
            <p className="text-sm font-semibold text-foreground">Connexion par WhatsApp</p>
